        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-xl font-bold text-white font-boldonse">JACKPOT ESTÁ VALIDO</p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <NavigationMenu className="max-w-none w-auto">
            <NavigationMenuList className="flex space-x-6 justify-center">
              <NavigationMenuItem>
                <NavigationMenuLink href={`/play-${gameName.toLowerCase().replace(/\s+/g, '-')}`} className="text-black dark:text-white hover:text-black/80 dark:hover:text-white/80 font-bebas text-lg py-3 px-4 flex items-center">
                  Jogar {gameName}
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink href={`/results/${gameName.toLowerCase().replace(/\s+/g, '-')}`} className="text-black dark:text-white hover:text-black/80 dark:hover:text-white/80 font-bebas text-lg py-3 px-4 flex items-center">
                  Resultados
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink className="text-black dark:text-white hover:text-black/80 dark:hover:text-white/80 font-bebas text-lg py-3 px-4 flex items-center" href={`/checker/${gameName.toLowerCase().replace(/\s+/g, '-')}`}>
                  Verificador de Números
                </NavigationMenuLink>
              </NavigationMenuItem>
              <NavigationMenuItem>
                <NavigationMenuLink href={`/how-to-play/${gameName.toLowerCase().replace(/\s+/g, '-')}`} className="text-black dark:text-white hover:text-black/80 dark:hover:text-white/80 font-bebas text-lg py-3 px-4 flex items-center">
                  Como Jogar
                </NavigationMenuLink>
              </NavigationMenuItem>
            </NavigationMenuList>
