              ...
              {regularNumbers.map(number => {
                ...
                return (
                  <button 
                    ...
                    style={{
                      backgroundColor: isSelected ? colorValue : isDimmed ? '#e6e6e6' : '#f3f4f6',
                      color: isSelected ? 'white' : isDimmed ? '#b0b0b0' : '#000000',
                  ...
                  {powerballNumbers.map(number => {
                    ...
                    return (
                      <button 
                        ...
                        transition-all duration-200`}
                        style={{
                          backgroundColor: isSelected ? 'rgb(245, 158, 11)' : isDimmed ? '#e6e6e6' : '#f3f4f6',
                          color: isSelected ? 'white' : isDimmed ? '#b0b0b0' : '#000000',
                          opacity: isDimmed ? 0.4 : 1
                        }}
                      >
